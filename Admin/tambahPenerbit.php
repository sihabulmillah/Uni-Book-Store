...
<div class="container mt-4">
  ...
  <table class="table table-borderless w-50">
    <tr>
      ...
      <td>:</td>
      <td><input type="text" id="id" class="form-control" name="id_penerbit"></td>
    </tr>
    <tr>
      <td><label for="nama">Nama</label></td>
      <td>:</td>
      <td><input type="text" id="nama" class="form-control" name="nama"></td>
    </tr>
    <tr>
      <td><label for="alamat">Alamat</label></td>
      <td>:</td>
      <td><input type="text" id="alamat" class="form-control" name="alamat"></td>
    </tr>
     <tr>
      <td><label for="kota">Kota</label></td>
      <td>:</td>
      <td><input type="text" id="kota" class="form-control" name="kota"></td>
    </tr>
    <tr>
      <td><label for="telepon">Telepon</label></td>
      <td>:</td>
      <td><input type="number" id="telepon" class="form-control" name="telepon"></td>
    </tr>
    <tr>
