...
<body style="font-family: poppins;">
  ...
  <table class="table table-borderless w-50">
    <tr>
      ...
      <td>:</td>
      <td><input type="text" class="form-control" id="id" name="id_buku"></td>
    </tr>
    <tr>
      <td><label for="kategori">Kategori</label></td>
      <td>:</td>
      <td><input type="text" class="form-control" id="kategori" name="kategori"></td>
    </tr>
    <tr>
      <td><label for="nama">Nama Buku</label></td>
      <td>:</td>
      <td><input type="text" class="form-control" id="nama" name="nama_buku"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td><input type="number" class="form-control" id="stok" name="stok"></td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <option hidden value="">Pilih Penerbit</option>
        <?php 
        foreach($penerbit as $data){
        ?>
        <option value="<?= $data['id_penerbit']?>"><?= $data['nama']?></option>
        <?php } ?>
      </select>
    </td>
    </tr>
    <tr>
      <td colspan="3" ><button type="submit" class="btn btn-success " name="save">Save</button></td>
    </tr>
  </table>
